...
# Generated by qmake (2.01a) (Qt 4.5.2) on: ter ago 25 11:12:31 2009
...
CFLAGS        = -pipe -O2 -g -pipe -Wformat -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -fomit-frame-pointer -march=i586 -mtune=generic -fasynchronous-unwind-tables -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -g -pipe -Wformat -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -fomit-frame-pointer -march=i586 -mtune=generic -fasynchronous-unwind-tables -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/lib/qt4/mkspecs/linux-g++ -I. -I/usr/lib/qt4/include/QtCore -I/usr/lib/qt4/include/QtGui -I/usr/lib/qt4/include/QtDBus -I/usr/lib/qt4/include -I. -I.
LINK          = g++
LFLAGS        = -Wl,--as-needed -Wl,--no-undefined -Wl,-z,relro -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/lib -pthread -pthread -pthread -pthread -pthread -pthread -lQtDBus -lQtXml -pthread -pthread -pthread -pthread -pthread -pthread -lQtGui -pthread -lpng -lfreetype -lgobject-2.0 -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtCore -lz -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/notifier1.0.0/ && $(COPY_FILE) --parents window.h .tmp/notifier1.0.0/ && $(COPY_FILE) --parents systray.qrc .tmp/notifier1.0.0/ && $(COPY_FILE) --parents main.cpp window.cpp .tmp/notifier1.0.0/ && (cd `dirname .tmp/notifier1.0.0` && $(TAR) notifier1.0.0.tar notifier1.0.0 && $(COMPRESS) notifier1.0.0.tar) && $(MOVE) `dirname .tmp/notifier1.0.0`/notifier1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/notifier1.0.0
